...
## Connectt to SQlite
connection=sqlite3.connect("retail_sales_db")
...
cursor.execute('''INSERT INTO sales_tb (TransactionID, Date, CustomerID, Gender, Age, ProductCategory, Quantity, PriceperUnit, TotalAmount)
VALUES
...
data=cursor.execute('''Select * from sales_tb''')
for row in data:
    print(row)
