...
start "Google Search API" cmd /k "python D:\GenAi\pythonProject\itheyasmart\Google-Search-MCP-Server\google_search.py"

REM Start Python link viewer in a new window
start "Link Viewer" cmd /k "python D:\GenAi\pythonProject\itheyasmart\Google-Search-MCP-Server\link_view.py"
...
node D:\GenAi\pythonProject\itheyasmart\Google-Search-MCP-Server\dist\google-search.js
